 ...
 */
public class LevelGenerator1 extends AbstractLevelGenerator{
	 ...
	 */
	public LevelGenerator1(GameDescription game, ElapsedCpuTimer elapsedTimer){
		random = new Random();
		minSize = 4;
		maxSize = 18;
